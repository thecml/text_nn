...
def parse_args():
    ...
    parser.add_argument('--results_path', type=str, default='results', help='where to dump model config and epoch stats. If get_rationales is set to true, rationales for the test set will also be stored here.')
